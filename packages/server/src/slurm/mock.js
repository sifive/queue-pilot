...
const JOBS = [
  { jobId: "60000001", name: "JobA-parent-runner", user: "jenkins-verif", account: "verif_performance",
    ...
    wckey: `:${flow}/`, workdir: `${wd}/g5soc_sim/parent`, nodelist: "omega101", dependency: "" },
  { jobId: "60000002", name: "JobA-origin-runner-2", user: "jenkins-verif", account: "verif_performance",
    partition: "standard_scl", state: "R", reason: "None", priority: 4294967288, pendingSeconds: 0,
    elapsedSeconds: 5400, timelimitSeconds: 86400, reqCpus: 4, reqMem: "8G",
    wckey: `:${flow}/`, workdir: `${wd}/g5soc_sim/root-2`, nodelist: "omega102", dependency: "" },
  { jobId: "60000042", name: "alu", user: "jenkins-verif", account: "verif_performance",
    ...
    wckey: `:${flow}/`, workdir: `${wd}/g5soc_sim/torture/alu`, nodelist: "", dependency: "" },
  { jobId: "60000043", name: "branch", user: "jenkins-verif", account: "verif_performance",
    ...
    elapsedSeconds: 0, timelimitSeconds: 1800, reqCpus: 1, reqMem: "8G",
    wckey: `:${flow}/`, workdir: `${wd}/g5soc_sim/torture/branch`, nodelist: "", dependency: "" },
  { jobId: "60000099", name: "wake-slurm-runner", user: "jenkins", account: "fed_ci",
    ...
    wckey: ":pre-merge-v2/", workdir: "/scratch/jenkins/archived-builds/nightly/x", nodelist: "", dependency: "" },
  { jobId: "60000110", name: "post-compile-runner", user: "jenkins-verif", account: "verif_tools",
    partition: "standard_scl", state: "R", reason: "None", priority: 4294967000, pendingSeconds: 0,
    elapsedSeconds: 1800, timelimitSeconds: 7200, reqCpus: 2, reqMem: "4G",
    wckey: ":post-compile/", workdir: "/scratch/jenkins/post-compile/root", nodelist: "omega150", dependency: "" },
  { jobId: "60000111", name: "post-compile-merge", user: "jenkins-verif", account: "verif_tools",
    partition: "standard_scl", state: "PD", reason: "Dependency", priority: 4000, pendingSeconds: 9200,
    elapsedSeconds: 0, timelimitSeconds: 2400, reqCpus: 2, reqMem: "4G",
    wckey: "", workdir: "/scratch/jenkins/post-compile/final", nodelist: "", dependency: "afterok:60000110" },
  { jobId: "60000500", name: "held-job", user: "dbone", account: "rtl_bulk",
    ...
    wckey: "", workdir: "/scratch/jenkins/x", nodelist: "", dependency: "" },
];
